...
public record Assistant
{
    ...
    public AssistantFirstMessageMode? FirstMessageMode { get; set; }
    ...
    public IEnumerable<AssistantClientMessagesItem>? ClientMessages { get; set; }

    /// <summary>
    /// These are the messages that will be sent to your Server URL. Default is conversation-update,end-of-call-report,function-call,hang,speech-update,status-update,tool-calls,transfer-destination-request,user-interrupted. You can check the shape of the messages in ServerMessage schema.
    /// </summary>
    [JsonPropertyName("serverMessages")]
    public IEnumerable<AssistantServerMessagesItem>? ServerMessages { get; set; }
    ...
    public AssistantBackgroundSound? BackgroundSound { get; set; }
